            ...
            {isLoading ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-5 mb-6">
                    {filteredTrainees.length > 0 ? filteredTrainees.map((trainee, index) => {
                        ...
                        >
                            <div onClick={() => navigate(`/hr/trainee/${trainee.trainee_id}`)} className="relative aspect-[4/3] w-full overflow-hidden bg-[var(--bg-workspace)] border-b border-[var(--border-color)] flex flex-col items-center justify-center cursor-pointer group/img">

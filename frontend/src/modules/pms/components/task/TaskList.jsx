        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-[var(--bg-workspace)] border-b border-[var(--border-color)]">
              <th className="px-6 py-4 text-[11px] font-bold text-[var(--text-muted)] uppercase tracking-wider">Task</th>
              <th className="px-6 py-4 text-[11px] font-bold text-[var(--text-muted)] uppercase tracking-wider">Project</th>
              <th className="px-6 py-4 text-[11px] font-bold text-[var(--text-muted)] uppercase tracking-wider">Assignee</th>
              <th className="px-6 py-4 text-[11px] font-bold text-[var(--text-muted)] uppercase tracking-wider">Status</th>
              <th className="px-6 py-4 text-[11px] font-bold text-[var(--text-muted)] uppercase tracking-wider">Priority</th>
              <th className="px-6 py-4 text-[11px] font-bold text-[var(--text-muted)] uppercase tracking-wider">Due Date</th>
          ...
          <tbody className="divide-y divide-[var(--border-color)]">
            {tasks.length === 0 ? (
              <tr>
                <td colSpan="7" className="px-6 py-10 text-center text-[var(--text-muted)] font-medium">
              ...
              tasks.map(task => {
                ...
                return (
                  <tr key={task.task_id} className="hover:bg-[var(--nav-hover)] transition-colors group">

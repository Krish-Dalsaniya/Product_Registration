...
import { fetchMyProfileApi, updateMyProfileApi } from '../../../api/hr';
...
const MyProfile = () => {
  ...
  const [addressInfo, setAddressInfo] = useState({}); const [emergencyContacts, setEmergencyContacts] = useState([]);
  ...
  const loadEmployee = async () => {
    try {
      setIsLoading(true);
      const empRes = await fetchMyProfileApi();
      ...
      if (empRes.data?.success) {
        ...
        if (emp.address_info) setAddressInfo({ ...addressInfo, ...emp.address_info });
        if (emp.emergency_contacts) setEmergencyContacts(emp.emergency_contacts);
  ...
  const handleSave = async () => {
    try {
      setIsSaving(true);
      const payload = { personal_info: personalInfo, address_info: addressInfo, emergency_contacts: emergencyContacts };
        ...
        <div className="space-y-8 animate-in fade-in duration-300">
          <div className="bg-[var(--bg-card)] border border-[var(--border-color)] rounded-2xl p-6 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-6 gap-x-8">
              <div>
                <FormField label="Email Address" type="email" disabled={true} value={employee.email || ''} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
              <div>
                <FormField label="Mobile Number" type="text" disabled={!(activeTab === 'Personal' && isEditing)} value={personalInfo.mobile_number} onChange={e => setPersonalInfo({...personalInfo, mobile_number: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
              <div>
                <FormField label="Nickname" type="text" disabled={!(activeTab === 'Personal' && isEditing)} value={personalInfo.nickname} onChange={e => setPersonalInfo({...personalInfo, nickname: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
              <div>
                <FormField label="Gender" type="select" disabled={!(activeTab === 'Personal' && isEditing)} value={personalInfo.gender} onChange={e => setPersonalInfo({...personalInfo, gender: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} options={[{ value: "Male", label: "Male" }, { value: "Female", label: "Female" }, { value: "Other", label: "Other" }]} />
              </div>
              <div>
                <FormField label="Date of Birth" type="date" disabled={!(activeTab === 'Personal' && isEditing)} value={personalInfo.dob} onChange={e => setPersonalInfo({...personalInfo, dob: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
              <div>
                <FormField label="Blood Group" type="select" disabled={!(activeTab === 'Personal' && isEditing)} value={personalInfo.blood_group} onChange={e => setPersonalInfo({...personalInfo, blood_group: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} options={[{ value: "", label: "Select" }, { value: "A+", label: "A+" }, { value: "A-", label: "A-" }, { value: "B+", label: "B+" }, { value: "B-", label: "B-" }, { value: "AB+", label: "AB+" }, { value: "AB-", label: "AB-" }, { value: "O+", label: "O+" }, { value: "O-", label: "O-" }]} />
              </div>
              <div>
                <FormField label="Father's Name" type="text" disabled={!(activeTab === 'Personal' && isEditing)} value={personalInfo.fathers_name} onChange={e => setPersonalInfo({...personalInfo, fathers_name: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
              <div>
                <FormField label="Residential Status" type="text" disabled={!(activeTab === 'Personal' && isEditing)} value={personalInfo.residential_status} onChange={e => setPersonalInfo({...personalInfo, residential_status: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
              <div>
                <FormField label="Place of Birth" type="text" disabled={!(activeTab === 'Personal' && isEditing)} value={personalInfo.place_of_birth} onChange={e => setPersonalInfo({...personalInfo, place_of_birth: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
              <div>
                <FormField label="Country of Origin" type="text" disabled={!(activeTab === 'Personal' && isEditing)} value={personalInfo.country_of_origin} onChange={e => setPersonalInfo({...personalInfo, country_of_origin: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
              <div>
                <FormField label="Religion & Caste" type="text" disabled={!(activeTab === 'Personal' && isEditing)} value={personalInfo.religion_caste} onChange={e => setPersonalInfo({...personalInfo, religion_caste: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
              <div>
                <FormField label="Physically Challenged?" type="select" disabled={!(activeTab === 'Personal' && isEditing)} value={personalInfo.physically_challenged} onChange={e => setPersonalInfo({...personalInfo, physically_challenged: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} options={[{ value: "No", label: "No" }, { value: "Yes", label: "Yes" }]} />
              </div>
              <div>
                <FormField label="Disability Type" type="text" disabled={!(activeTab === 'Personal' && isEditing) ||  personalInfo.physically_challenged === 'No'} value={personalInfo.disability_type} onChange={e => setPersonalInfo({...personalInfo, disability_type: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
              <div>
                <FormField label="International Employee?" type="select" disabled={!(activeTab === 'Personal' && isEditing)} value={personalInfo.international_employee} onChange={e => setPersonalInfo({...personalInfo, international_employee: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} options={[{ value: "No", label: "No" }, { value: "Yes", label: "Yes" }]} />
              </div>
              <div>
                <FormField label="Is Director?" type="select" disabled={!(activeTab === 'Personal' && isEditing)} value={personalInfo.is_director} onChange={e => setPersonalInfo({...personalInfo, is_director: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} options={[{ value: "No", label: "No" }, { value: "Yes", label: "Yes" }]} />
              </div>
              <div>
                <FormField label="Hobby" type="text" disabled={!(activeTab === 'Personal' && isEditing)} value={personalInfo.hobby} onChange={e => setPersonalInfo({...personalInfo, hobby: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
            </div>
          </div>
          ...
          <div className="bg-[var(--bg-card)] border border-[var(--border-color)] rounded-2xl p-6 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-6 gap-x-8">
              <div>
                <FormField label="Height (cm)" type="number" disabled={!(activeTab === 'Personal' && isEditing)} value={personalInfo.height} onChange={e => setPersonalInfo({...personalInfo, height: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
              <div>
                <FormField label="Weight (kg)" type="number" disabled={!(activeTab === 'Personal' && isEditing)} value={personalInfo.weight} onChange={e => setPersonalInfo({...personalInfo, weight: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
              <div>
                <FormField label="Identification Mark" type="text" disabled={!(activeTab === 'Personal' && isEditing)} value={personalInfo.identification_mark} onChange={e => setPersonalInfo({...personalInfo, identification_mark: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
            </div>
          </div>
          ...
          <div className="bg-[var(--bg-card)] border border-[var(--border-color)] rounded-2xl p-6 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-6 gap-x-8">
              <div>
                <FormField label="Marital Status" type="select" disabled={!(activeTab === 'Personal' && isEditing)} value={personalInfo.marital_status} onChange={e => setPersonalInfo({...personalInfo, marital_status: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} options={[{ value: "Single", label: "Single" }, { value: "Married", label: "Married" }, { value: "Divorced", label: "Divorced" }, { value: "Widowed", label: "Widowed" }]} />
              </div>
              <div>
                <FormField label="Spouse Name" type="text" disabled={!(activeTab === 'Personal' && isEditing) ||  personalInfo.marital_status !== 'Married'} value={personalInfo.spouse_name} onChange={e => setPersonalInfo({...personalInfo, spouse_name: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
              <div>
                <FormField label="Marriage Date" type="date" disabled={!(activeTab === 'Personal' && isEditing) ||  personalInfo.marital_status !== 'Married'} value={personalInfo.marriage_date} onChange={e => setPersonalInfo({...personalInfo, marriage_date: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
            </div>
          </div>
        </div>
      ...
      {activeTab === 'Job' && (
        <div className="space-y-8 animate-in fade-in duration-300">
          <div className="bg-[var(--bg-card)] border border-[var(--border-color)] rounded-2xl p-6 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-6 gap-x-8">
              <div>
                <FormField label="Date of Hiring" type="date" disabled={!(activeTab === 'Personal' && isEditing)} value={jobInfo.date_of_hiring} onChange={e => setJobInfo({...jobInfo, date_of_hiring: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
              <div>
                <FormField label="Confirmation Date" type="date" disabled={!(activeTab === 'Personal' && isEditing)} value={jobInfo.confirmation_date} onChange={e => setJobInfo({...jobInfo, confirmation_date: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
              <div>
                <FormField label="Probation Period" type="text" disabled={!(activeTab === 'Personal' && isEditing)} value={jobInfo.probation_period} onChange={e => setJobInfo({...jobInfo, probation_period: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
              <div>
                <FormField label="Notice Period" type="text" disabled={!(activeTab === 'Personal' && isEditing)} value={jobInfo.notice_period} onChange={e => setJobInfo({...jobInfo, notice_period: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
              <div>
                <FormField label="Current Company Experience" type="text" disabled={!(activeTab === 'Personal' && isEditing)} value={jobInfo.current_company_experience} onChange={e => setJobInfo({...jobInfo, current_company_experience: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
              <div>
                <FormField label="Referred By" type="text" disabled={!(activeTab === 'Personal' && isEditing)} value={jobInfo.referred_by} onChange={e => setJobInfo({...jobInfo, referred_by: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
              <div>
                <FormField 
      ...
      {activeTab === 'Pay and Benefits' && (
        <div className="space-y-8 animate-in fade-in duration-300">
          <div className="bg-[var(--bg-card)] border border-[var(--border-color)] rounded-2xl p-6 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-6 gap-x-8">
              <div>
                <FormField label="Name As Per Bank" type="text" disabled={!(activeTab === 'Personal' && isEditing)} value={payInfo.name_on_account} onChange={e => setPayInfo({...payInfo, name_on_account: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
              <div>
                <FormField label="Bank Name" type="text" disabled={!(activeTab === 'Personal' && isEditing)} value={payInfo.bank_name} onChange={e => setPayInfo({...payInfo, bank_name: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
              <div>
                <FormField label="Bank Branch" type="text" disabled={!(activeTab === 'Personal' && isEditing)} value={payInfo.bank_branch} onChange={e => setPayInfo({...payInfo, bank_branch: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
              <div>
                <FormField label="Bank Account No." type="text" disabled={!(activeTab === 'Personal' && isEditing)} value={payInfo.bank_account_no} onChange={e => setPayInfo({...payInfo, bank_account_no: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
              <div>
                <FormField label="IFSC Code" type="text" disabled={!(activeTab === 'Personal' && isEditing)} value={payInfo.ifsc_code} onChange={e => setPayInfo({...payInfo, ifsc_code: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
              <div>
                <FormField label="Account Type" type="select" disabled={!(activeTab === 'Personal' && isEditing)} value={payInfo.account_type} onChange={e => setPayInfo({...payInfo, account_type: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} options={[{ value: "Savings", label: "Savings" }, { value: "Current", label: "Current" }]} />
              </div>
              <div>
                <FormField label="Payment Type" type="select" disabled={!(activeTab === 'Personal' && isEditing)} value={payInfo.payment_type} onChange={e => setPayInfo({...payInfo, payment_type: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} options={[{ value: "Bank Transfer", label: "Bank Transfer" }, { value: "Cheque", label: "Cheque" }, { value: "Cash", label: "Cash" }]} />
              </div>
              <div>
                <FormField label="DD Payable At" type="text" disabled={!(activeTab === 'Personal' && isEditing)} value={payInfo.dd_payable_at} onChange={e => setPayInfo({...payInfo, dd_payable_at: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
            </div>
          </div>
        </div>
      ...
      {activeTab === 'Statutory' && (
        <div className="space-y-8 animate-in fade-in duration-300">
          ...
          <div className="bg-[var(--bg-card)] border border-[var(--border-color)] rounded-2xl p-6 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-6 gap-x-8">
              <div>
                <FormField label="Covered Under ESI?" type="select" disabled={!(activeTab === 'Personal' && isEditing)} value={statutoryInfo.esi_covered} onChange={e => setStatutoryInfo({...statutoryInfo, esi_covered: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} options={[{ value: "No", label: "No" }, { value: "Yes", label: "Yes" }]} />
              </div>
              <div>
                <FormField label="ESI Number" type="text" disabled={!(activeTab === 'Personal' && isEditing) ||  statutoryInfo.esi_covered === 'No'} value={statutoryInfo.esi_number} onChange={e => setStatutoryInfo({...statutoryInfo, esi_number: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
            </div>
          </div>
          ...
          <div className="bg-[var(--bg-card)] border border-[var(--border-color)] rounded-2xl p-6 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-6 gap-x-8">
              <div>
                <FormField label="Covered Under PF?" type="select" disabled={!(activeTab === 'Personal' && isEditing)} value={statutoryInfo.pf_covered} onChange={e => setStatutoryInfo({...statutoryInfo, pf_covered: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} options={[{ value: "No", label: "No" }, { value: "Yes", label: "Yes" }]} />
              </div>
              <div>
                <FormField label="UAN" type="text" disabled={!(activeTab === 'Personal' && isEditing) ||  statutoryInfo.pf_covered === 'No'} value={statutoryInfo.uan} onChange={e => setStatutoryInfo({...statutoryInfo, uan: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
              <div>
                <FormField label="PF No." type="text" disabled={!(activeTab === 'Personal' && isEditing) ||  statutoryInfo.pf_covered === 'No'} value={statutoryInfo.pf_no} onChange={e => setStatutoryInfo({...statutoryInfo, pf_no: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
              <div>
                <FormField label="PF Join Date" type="date" disabled={!(activeTab === 'Personal' && isEditing) ||  statutoryInfo.pf_covered === 'No'} value={statutoryInfo.pf_join_date} onChange={e => setStatutoryInfo({...statutoryInfo, pf_join_date: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
              <div>
                <FormField label="Family PF No." type="text" disabled={!(activeTab === 'Personal' && isEditing) ||  statutoryInfo.pf_covered === 'No'} value={statutoryInfo.family_pf_no} onChange={e => setStatutoryInfo({...statutoryInfo, family_pf_no: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
              <div>
                <FormField label="Existing Member of EPS?" type="select" disabled={!(activeTab === 'Personal' && isEditing) ||  statutoryInfo.pf_covered === 'No'} value={statutoryInfo.eps_member} onChange={e => setStatutoryInfo({...statutoryInfo, eps_member: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} options={[{ value: "No", label: "No" }, { value: "Yes", label: "Yes" }]} />
              </div>
              <div>
                <FormField label="Allow Excess EPF Contribution?" type="select" disabled={!(activeTab === 'Personal' && isEditing) ||  statutoryInfo.pf_covered === 'No'} value={statutoryInfo.excess_epf} onChange={e => setStatutoryInfo({...statutoryInfo, excess_epf: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} options={[{ value: "No", label: "No" }, { value: "Yes", label: "Yes" }]} />
              </div>
              <div>
                <FormField label="Allow Excess EPS Contribution?" type="select" disabled={!(activeTab === 'Personal' && isEditing) ||  statutoryInfo.pf_covered === 'No'} value={statutoryInfo.excess_eps} onChange={e => setStatutoryInfo({...statutoryInfo, excess_eps: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} options={[{ value: "No", label: "No" }, { value: "Yes", label: "Yes" }]} />
              </div>
              <div>
                <FormField label="Note" type="text" disabled={!(activeTab === 'Personal' && isEditing) ||  statutoryInfo.pf_covered === 'No'} value={statutoryInfo.pf_note} onChange={e => setStatutoryInfo({...statutoryInfo, pf_note: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
            </div>
          </div>
          ...
          <div className="bg-[var(--bg-card)] border border-[var(--border-color)] rounded-2xl p-6 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-6 gap-x-8">
              <div>
                <FormField label="Covered Under LWF?" type="select" disabled={!(activeTab === 'Personal' && isEditing)} value={statutoryInfo.lwf_covered} onChange={e => setStatutoryInfo({...statutoryInfo, lwf_covered: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} options={[{ value: "No", label: "No" }, { value: "Yes", label: "Yes" }]} />
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="border border-[var(--border-color)] rounded-xl p-5 bg-[var(--bg-workspace)]">
                ...
                <div className="space-y-4">
                  <div>
                    <FormField label="Document No." type="text" disabled={!(activeTab === 'Personal' && isEditing)} value={identitiesInfo.pan_doc_no} onChange={e => setIdentitiesInfo({...identitiesInfo, pan_doc_no: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
                  </div>
                  <div>
                    <FormField label="Name As Per Document" type="text" disabled={!(activeTab === 'Personal' && isEditing)} value={identitiesInfo.pan_name} onChange={e => setIdentitiesInfo({...identitiesInfo, pan_name: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
                  </div>
                </div>
              </div>
              ...
              <div className="border border-[var(--border-color)] rounded-xl p-5 bg-[var(--bg-workspace)]">
                ...
                <div className="space-y-4">
                  <div>
                    <FormField label="Document No." type="text" disabled={!(activeTab === 'Personal' && isEditing)} value={identitiesInfo.bank_doc_no} onChange={e => setIdentitiesInfo({...identitiesInfo, bank_doc_no: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
                  </div>
                  <div>
                    <FormField label="Name As Per Document" type="text" disabled={!(activeTab === 'Personal' && isEditing)} value={identitiesInfo.bank_name_on_doc} onChange={e => setIdentitiesInfo({...identitiesInfo, bank_name_on_doc: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
                  </div>
                </div>
              </div>
              ...
              <div className="border border-[var(--border-color)] rounded-xl p-5 bg-[var(--bg-workspace)]">
                ...
                <div className="space-y-4">
                  <div>
                    <FormField label="Document No." type="text" disabled={!(activeTab === 'Personal' && isEditing)} value={identitiesInfo.aadhaar_doc_no} onChange={e => setIdentitiesInfo({...identitiesInfo, aadhaar_doc_no: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
                  </div>
                  <div>
                    <FormField label="Name As Per Document" type="text" disabled={!(activeTab === 'Personal' && isEditing)} value={identitiesInfo.aadhaar_name} onChange={e => setIdentitiesInfo({...identitiesInfo, aadhaar_name: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
                  </div>
                </div>
              </div>
      ...
      {activeTab === 'Admin Data' && (
        <div className="space-y-8 animate-in fade-in duration-300">
          <div className="bg-[var(--bg-card)] border border-[var(--border-color)] rounded-2xl p-6 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-6 gap-x-8">
              <div>
                <FormField label="Base Salary (LPA / Annual)" type="number" disabled={!(activeTab === 'Personal' && isEditing)} value={employee.base_salary} onChange={e => setEmployee({...employee, base_salary: e.target.value})} isEditing={activeTab === 'Personal' && isEditing} />
              </div>
            </div>
            {!isEditing && (

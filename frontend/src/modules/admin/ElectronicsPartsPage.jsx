                      ...
                      return (
                        <div key={cat} className="relative group/cat animate-in fade-in slide-in-from-bottom-2" style={{ animationDelay: `${idx * 40}ms` }}>
                            <button 
                               ...
                               className="p-5 w-full bg-[var(--bg-card)] backdrop-blur-md border border-[var(--border-color)] rounded-[28px] hover:border-[#3b82f6] hover:bg-[var(--nav-hover)] transition-all duration-500 group flex flex-col items-center gap-3 hover:-translate-y-1.5 hover:shadow-xl relative overflow-hidden"
                            >
                               <div className="w-10 h-10 bg-[var(--bg-workspace)] border border-[var(--border-color)] rounded-[14px] flex items-center justify-center shadow-sm group-hover:border-[#3b82f6] transition-all duration-500 group-hover:scale-110 relative z-10">

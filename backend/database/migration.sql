...
ALTER TABLE IF EXISTS users ADD COLUMN IF NOT EXISTS company VARCHAR(255);
ALTER TABLE IF EXISTS users ADD COLUMN IF NOT EXISTS has_custom_permissions BOOLEAN DEFAULT false;

-- 1b. Add created_by to customers and book_a_sale for non-admin dashboards
ALTER TABLE IF EXISTS customers ADD COLUMN IF NOT EXISTS created_by UUID REFERENCES users(user_id) ON DELETE SET NULL;
ALTER TABLE IF EXISTS book_a_sale ADD COLUMN IF NOT EXISTS created_by UUID REFERENCES users(user_id) ON DELETE SET NULL;
...
ALTER TABLE IF EXISTS hr_lms_assignments 
ADD COLUMN IF NOT EXISTS trainee_id UUID REFERENCES hr_trainees(trainee_id) ON DELETE CASCADE;

ALTER TABLE IF EXISTS hr_lms_assignments ALTER COLUMN employee_id DROP NOT NULL;


-- Adding image_url to hr_trainees

ALTER TABLE IF EXISTS hr_trainees ADD COLUMN IF NOT EXISTS image_url TEXT;
...
ALTER TABLE IF EXISTS hr_attendance ADD COLUMN IF NOT EXISTS punch_in_selfie_url TEXT;
ALTER TABLE IF EXISTS hr_attendance ADD COLUMN IF NOT EXISTS punch_in_latitude DECIMAL(10, 8);
ALTER TABLE IF EXISTS hr_attendance ADD COLUMN IF NOT EXISTS punch_in_longitude DECIMAL(11, 8);
ALTER TABLE IF EXISTS hr_attendance ADD COLUMN IF NOT EXISTS punch_in_device_info TEXT;
ALTER TABLE IF EXISTS hr_attendance ADD COLUMN IF NOT EXISTS punch_in_ip VARCHAR(45);
ALTER TABLE IF EXISTS hr_attendance ADD COLUMN IF NOT EXISTS punch_in_liveness_challenge VARCHAR(50);
ALTER TABLE IF EXISTS hr_attendance ADD COLUMN IF NOT EXISTS punch_in_liveness_status VARCHAR(50);
ALTER TABLE IF EXISTS hr_attendance ADD COLUMN IF NOT EXISTS punch_in_face_match_score DECIMAL(5,2);

ALTER TABLE IF EXISTS hr_attendance ADD COLUMN IF NOT EXISTS punch_out_selfie_url TEXT;
ALTER TABLE IF EXISTS hr_attendance ADD COLUMN IF NOT EXISTS punch_out_latitude DECIMAL(10, 8);
ALTER TABLE IF EXISTS hr_attendance ADD COLUMN IF NOT EXISTS punch_out_longitude DECIMAL(11, 8);
ALTER TABLE IF EXISTS hr_attendance ADD COLUMN IF NOT EXISTS punch_out_device_info TEXT;
ALTER TABLE IF EXISTS hr_attendance ADD COLUMN IF NOT EXISTS punch_out_ip VARCHAR(45);
ALTER TABLE IF EXISTS hr_attendance ADD COLUMN IF NOT EXISTS punch_out_liveness_challenge VARCHAR(50);
ALTER TABLE IF EXISTS hr_attendance ADD COLUMN IF NOT EXISTS punch_out_liveness_status VARCHAR(50);
ALTER TABLE IF EXISTS hr_attendance ADD COLUMN IF NOT EXISTS punch_out_face_match_score DECIMAL(5,2);

ALTER TABLE IF EXISTS hr_employees ADD COLUMN IF NOT EXISTS face_descriptor JSONB;


-- Adding Face Recognition Attendance fields
ALTER TABLE IF EXISTS hr_employees ADD COLUMN IF NOT EXISTS face_embedding JSONB;
ALTER TABLE IF EXISTS hr_attendance ADD COLUMN IF NOT EXISTS punch_in_face_match_score DECIMAL(5,2);
ALTER TABLE IF EXISTS hr_attendance ADD COLUMN IF NOT EXISTS punch_in_face_status VARCHAR(50);
ALTER TABLE IF EXISTS hr_attendance ADD COLUMN IF NOT EXISTS punch_out_face_match_score DECIMAL(5,2);
ALTER TABLE IF EXISTS hr_attendance ADD COLUMN IF NOT EXISTS punch_out_face_status VARCHAR(50);
...
ALTER TABLE IF EXISTS hr_employees ADD COLUMN IF NOT EXISTS org_chart_parent_id UUID REFERENCES hr_employees(employee_id) ON DELETE SET NULL;

-- Make hr_designations hierarchical for organogram
ALTER TABLE IF EXISTS hr_designations ADD COLUMN IF NOT EXISTS parent_id UUID REFERENCES hr_designations(designation_id) ON DELETE SET NULL;
ALTER TABLE IF EXISTS hr_designations ADD COLUMN IF NOT EXISTS job_description TEXT;
ALTER TABLE IF EXISTS hr_designations ADD COLUMN IF NOT EXISTS perks TEXT;


-- Add extra details fields to hr_designations
ALTER TABLE IF EXISTS hr_designations ADD COLUMN IF NOT EXISTS rcd_document_url TEXT;
ALTER TABLE IF EXISTS hr_designations ADD COLUMN IF NOT EXISTS pre_requisites TEXT;
ALTER TABLE IF EXISTS hr_designations ADD COLUMN IF NOT EXISTS training_requirements TEXT;
ALTER TABLE IF EXISTS hr_designations ADD COLUMN IF NOT EXISTS eligibility_criteria TEXT;
ALTER TABLE IF EXISTS hr_designations ADD COLUMN IF NOT EXISTS kpi TEXT;
ALTER TABLE IF EXISTS hr_designations ADD COLUMN IF NOT EXISTS kra TEXT;
...
ALTER TABLE IF EXISTS hr_candidates ADD COLUMN IF NOT EXISTS technical_details JSONB DEFAULT '{}';

COMMIT;

-- Added advanced attendance metrics
ALTER TABLE IF EXISTS hr_attendance ADD COLUMN IF NOT EXISTS late_coming VARCHAR(10) DEFAULT '00:00', ADD COLUMN IF NOT EXISTS early_going VARCHAR(10) DEFAULT '00:00', ADD COLUMN IF NOT EXISTS break_hours VARCHAR(10) DEFAULT '00:00', ADD COLUMN IF NOT EXISTS extra_hours VARCHAR(10) DEFAULT '00:00';
ALTER TABLE IF EXISTS hr_employees ADD COLUMN IF NOT EXISTS emergency_info JSONB, ADD COLUMN IF NOT EXISTS family_info JSONB;

ALTER TABLE IF EXISTS hr_candidates ADD COLUMN IF NOT EXISTS education_details JSONB DEFAULT '{}'::jsonb;
ALTER TABLE IF EXISTS hr_candidates ADD COLUMN IF NOT EXISTS trello_metadata JSONB DEFAULT '{}'::jsonb;
...
ALTER TABLE IF EXISTS pms_tasks ADD COLUMN IF NOT EXISTS sprint_id UUID REFERENCES pms_sprints(sprint_id) ON DELETE SET NULL;
ALTER TABLE IF EXISTS pms_tasks ADD COLUMN IF NOT EXISTS story_points INTEGER DEFAULT 0;
...
ALTER TABLE IF EXISTS pms_tasks ADD COLUMN IF NOT EXISTS epic_id UUID REFERENCES pms_epics(epic_id) ON DELETE SET NULL;
...
ALTER TABLE IF EXISTS hr_trainees ADD COLUMN IF NOT EXISTS designation_id UUID REFERENCES hr_designations(designation_id) ON DELETE SET NULL;
...
ALTER TABLE IF EXISTS pms_projects 
...
ALTER TABLE IF EXISTS finished_goods 
ADD COLUMN IF NOT EXISTS repository_owner VARCHAR(255),
ADD COLUMN IF NOT EXISTS repository_name VARCHAR(255),
...
ALTER TABLE IF EXISTS hr_candidates DROP COLUMN IF EXISTS monthly_taken_home;
ALTER TABLE IF EXISTS hr_candidates DROP COLUMN IF EXISTS expected_monthly;
ALTER TABLE IF EXISTS hr_candidates ADD COLUMN IF NOT EXISTS past_experiences JSONB DEFAULT '[]'::jsonb;

-- 2026-07-10: Add policy_checklist to hr_onboarding
ALTER TABLE IF EXISTS hr_onboarding ADD COLUMN IF NOT EXISTS policy_checklist JSONB DEFAULT '[]'::jsonb;
...
-- ==============================================================================
ALTER TABLE IF EXISTS hr_candidates ADD COLUMN IF NOT EXISTS applied_at JSONB DEFAULT '[]'::jsonb;
ALTER TABLE IF EXISTS hr_candidates ADD COLUMN IF NOT EXISTS shortlisted_for JSONB DEFAULT '[]'::jsonb;

-- Add user_id to hr_interns
ALTER TABLE IF EXISTS hr_interns ADD COLUMN IF NOT EXISTS user_id UUID REFERENCES users(user_id);
...
ALTER TABLE IF EXISTS PROCESSOR_MASTER ADD COLUMN IF NOT EXISTS manufacturer VARCHAR(255) DEFAULT 'N/A';
ALTER TABLE IF EXISTS PROCESSOR_MASTER ADD COLUMN IF NOT EXISTS core VARCHAR(100) DEFAULT 'N/A';
ALTER TABLE IF EXISTS PROCESSOR_MASTER ADD COLUMN IF NOT EXISTS flash VARCHAR(100) DEFAULT 'N/A';
ALTER TABLE IF EXISTS PROCESSOR_MASTER ADD COLUMN IF NOT EXISTS ram VARCHAR(100) DEFAULT 'N/A';
ALTER TABLE IF EXISTS PROCESSOR_MASTER ADD COLUMN IF NOT EXISTS clock VARCHAR(100) DEFAULT 'N/A';
ALTER TABLE IF EXISTS PROCESSOR_MASTER ADD COLUMN IF NOT EXISTS stock_quantity INT DEFAULT 0;

-- 2. Add repository_name to FIRMWARE_MASTER
ALTER TABLE IF EXISTS FIRMWARE_MASTER ADD COLUMN IF NOT EXISTS repository_name VARCHAR(255);

-- 3. Link Firmware Versions to Git
ALTER TABLE IF EXISTS FIRMWARE_VERSION_MASTER ADD COLUMN IF NOT EXISTS git_commit VARCHAR(40);
ALTER TABLE IF EXISTS FIRMWARE_VERSION_MASTER ADD COLUMN IF NOT EXISTS git_tag VARCHAR(100);
...
ALTER TABLE IF EXISTS FINISHED_GOODS ADD COLUMN IF NOT EXISTS product_version_id BIGINT REFERENCES PRODUCT_VERSION_MASTER(product_version_id) ON DELETE SET NULL;
...
ALTER TABLE IF EXISTS candidate_evaluation_forms ADD COLUMN IF NOT EXISTS form_mode VARCHAR(20) DEFAULT 'assessment';

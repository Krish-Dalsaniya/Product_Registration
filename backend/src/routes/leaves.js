...
const { getLeaveSummary, getUpcomingLeaves, applyForLeave, getCalendarData, getAllPendingRequests, updateLeaveStatus, getUserLeaveBalances, getEmployeeLeaveData } = require('../controllers/leavesController');
